"""
Django settings for mi_registro_completo project.
...
SECRET_KEY = 'django-insecure-akc8ckg65f9yr@6gl0q0ie0+!r^)k_zw$8f1w)mdm71-_m@!m+'
...
'django.middleware.common.CommonMiddleware',                   # Middleware común necesario para Django
...
ROOT_URLCONF = 'mi_registro_completo.urls'
...
WSGI_APPLICATION = 'mi_registro_completo.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'mi_registro_db'),
